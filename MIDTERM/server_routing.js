...
//this respords a Profile 
app.get('/Antonio', function (req, res) {
    console.log("Got a GET request for /Antonio");
    res.send("This is Page Profile Im a SOC Student who is a fraghead");
